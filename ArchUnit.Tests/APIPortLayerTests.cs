            ...
            .NotDependOnAny(
                Types()
                    ...
                    .DoNotResideInNamespaceMatching(
                        $"^({Constants.CoverageCollectorNamespace}|System.*|{Constants.NameSpacePrefix}\\.API\\.Ports|{Constants.NameSpacePrefix}\\.API\\.Ports\\..*|{Constants.NameSpacePrefix}\\.Domain\\.Data.*)$"
                    )
            );
