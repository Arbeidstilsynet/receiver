...
using CreateMeldingRequest = Arbeidstilsynet.MeldingerReceiver.Domain.Ports.App.CreateMeldingRequest;
...
internal class MeldingService : IMeldingService
{
    ...
    )
    {
        ...
        var createMeldingRequest = new Domain.Ports.Infrastructure.Dto.CreateMeldingRequest
        {
            Id = meldingId,
    ...
    {
        return _mapper.Map<Domain.Ports.App.PaginationResponse<Melding>>(
