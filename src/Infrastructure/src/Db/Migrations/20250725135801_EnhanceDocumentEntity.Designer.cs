...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.AltinnAppRegistrationEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.DocumentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.MeldingEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.AltinnAppRegistrationEntity", b =>
                {
                    b.OwnsOne("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.AltinnSubscriptionEntity", "AltinnSubscription", b1 =>
                        {
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.DocumentEntity", b =>
                {
                    b.HasOne("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.MeldingEntity", null)
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.MeldingEntity", b =>
                {
                    b.HasOne("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.DocumentEntity", "MainContent")
                        .WithMany()
