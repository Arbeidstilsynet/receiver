...
namespace Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Migrations
{
    ...
    [Migration("20260126065135_RefactorSubscriptionModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.AltinnSubscriptionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("registered_altinn_apps", "public");
                });

            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.ApiSubscriptionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("registered_default_apps", "public");
                });
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.MeldingEntity", b =>
                {
                    ...
                    b.ToTable("meldinger", "public");
                });

            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.SubscriptionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("registered_subscriptions", "public");
                });
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.AltinnSubscriptionEntity", b =>
                {
                    b.HasOne("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.SubscriptionEntity", "SubscriptionEntity")
                        .WithMany("RegisteredAltinnApps")
                        .HasForeignKey("SubscriptionEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SubscriptionEntity");
                });

            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.ApiSubscriptionEntity", b =>
                {
                    b.HasOne("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.SubscriptionEntity", "SubscriptionEntity")
                        .WithMany("RegisteredApiApps")
                        .HasForeignKey("SubscriptionEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.DocumentEntity", b =>
                {
                    b.HasOne("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.MeldingEntity", "Melding")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.SubscriptionEntity", b =>
                {
                    b.Navigation("RegisteredAltinnApps");

                    b.Navigation("RegisteredApiApps");
                });
