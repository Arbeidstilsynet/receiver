...
namespace Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Migrations
{
    ...
    [Migration("20260701104112_FixVersionUpdate")]
    partial class FixVersionUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.AltinnSubscriptionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.ApiSubscriptionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.MeldingEntity", b =>
                {
                    ...
                    b.Property<string>("ShortId")
                        ...
                        .HasColumnType("text")
                        .HasComputedColumnSql("right(\"Id\"::text, 12)", true);
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.SubscriptionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.AltinnSubscriptionEntity", b =>
                {
                    b.HasOne("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.SubscriptionEntity", "SubscriptionEntity")
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.DocumentEntity", b =>
                {
                    b.HasOne("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Db.Model.MeldingEntity", "Melding")
                        .WithMany("Documents")
