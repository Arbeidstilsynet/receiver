...
namespace Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Migrations
{
    ...
    [Migration("20250725135801_EnhanceDocumentEntity")]
    partial class EnhanceDocumentEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.AltinnAppRegistrationEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("registered_altinn_apps", "receiver");
                });

            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.DocumentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("InternalDocumentReference")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<Guid?>("MeldingEntityId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MeldingEntityId");

                    b.ToTable("documents", "receiver");
                });

            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.MeldingEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Dictionary<string, string>>("InternalTags")
                        .IsRequired()
                        .HasColumnType("hstore");

                    b.Property<Guid>("MainContentId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MainContentId");

                    b.ToTable("meldinger", "receiver");
                });
            ...
            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.AltinnAppRegistrationEntity", b =>
                {
                    b.OwnsOne("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.AltinnSubscriptionEntity", "AltinnSubscription", b1 =>
                        {
                            b1.Property<Guid>("AltinnAppRegistrationEntityId")
                                .HasColumnType("uuid");

                            b1.Property<string>("AlternativeSubjectFilter")
                                .HasColumnType("text");
                            ...
                            b1.Property<string>("SourceFilter")
                                .HasColumnType("text");

                            b1.Property<string>("SubjectFilter")
                                .HasColumnType("text");

                            b1.Property<string>("TypeFilter")
                                .HasColumnType("text");

                            b1.HasKey("AltinnAppRegistrationEntityId");

                            b1.ToTable("registered_altinn_apps", "receiver");

                            b1.WithOwner()
                                .HasForeignKey("AltinnAppRegistrationEntityId");
                        });

                    b.Navigation("AltinnSubscription")
                        .IsRequired();
                });

            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.DocumentEntity", b =>
                {
                    b.HasOne("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.MeldingEntity", null)
                        .WithMany("Attachments")
                        .HasForeignKey("MeldingEntityId");
                });

            modelBuilder.Entity("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.MeldingEntity", b =>
                {
                    b.HasOne("Arbeidstilsynet.MeldingerReceiver.Infrastructure.Adapters.Db.Model.DocumentEntity", "MainContent")
                        .WithMany()
                        .HasForeignKey("MainContentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
